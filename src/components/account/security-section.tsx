      ...
      <Card className="overflow-hidden border border-border">
        ...
        <CardContent className="p-6 space-y-6">
          <div className="space-y-4">
            {/* Email & Password connection - Responsive Stacking */}
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4">
              ...
              {/* Right side (badges) */} 
              <div className="flex items-center gap-2 self-start sm:self-center"> {/* Align badges left on mobile stack */}
                {isEmailPasswordConnected && (
                  <Badge variant="outline" className="bg-primary/10 text-primary border-primary/20 whitespace-normal">
                    {t("securitySection.primary")}
                  </Badge>
                )}
                <Badge variant={isEmailPasswordConnected ? "secondary" : "outline"} className="whitespace-normal">
                  {isEmailPasswordConnected ? t("securitySection.connected") : t("securitySection.notConnected")}
                </Badge>
              </div>
            </div>
            
            {/* Google connection - Responsive Stacking */}
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4">
              {/* Left side */} 
              <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2 self-start sm:self-center"> {/* Align badges left on mobile stack */}
                ...
                <Badge variant={isGoogleConnected ? "secondary" : "outline"} className="whitespace-normal">
